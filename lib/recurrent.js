...
(function(global) {
    ...
    Graph.prototype = {
        ...
        doMulBackprop: function(m1, m2, out){
          var n = m1.n;
          var d = m2.d;

          //console.log(m1.n, m2.d, m1.d);
        ...
        doTanhBackprop: function(m, n, out){
          for (var i = 0; i < n; i++) {
        ...
        doAddBackprop: function(m1, m2, out){
          for (var i = 0, n = m1.w.length; i < n; i++) {
              m1.dw[i] += out.dw[i];
              m2.dw[i] += out.dw[i];
          }
        ...
        rowPluck: function(m, ix) {
            ...
            if (this.needs_backprop) {
                ...
                this.backprop.push(() => this.doRowPluckBackprop(m, ix, out));
        ...
        tanh: function(m) {
            ...
            if (this.needs_backprop) {
                ...
                // }
                // this.backprop.push(backward);
                this.backprop.push(() => this.doTanhBackprop(m, n, out));
            }
            return out;
        },
        sigmoid: function(m) {
        ...
        mul: function(m1, m2) {
            ...
            if (this.needs_backprop) {
                ...
                //     }
                // }
                this.backprop.push(() => this.doMulBackprop(m1, m2, out));
            }
            return out;
        },
        add: function(m1, m2) {
            ...
            if (this.needs_backprop) {
                ...
                // this.backprop.push(backward);
                //
                this.backprop.push(() => this.doAddBackprop(m1, m2, out));
            }
            return out;
        },
        eltmul: function(m1, m2) {
            ...
            if (this.needs_backprop) {
                ...
                this.backprop.push(() => this.doEltmulBackprop(m1, m2, out));
            }
            return out;
        },
    }
